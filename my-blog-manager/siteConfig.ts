...
// 修改这里：变成图片数组
  bgImages: ["/assets/images/desktop-light-bg.jpg"],

  // 4. 文章默认封面图 (当 Markdown 没写 cover 时显示)
  defaultPostCover: "/assets/images/desktop-light-bg.jpg",
  ...
  friendLinkApplyFormat: "名称：CPZD\n简介：记录开发、学习、生活与分享。\n链接：https://cpzd.top\n头像：https://cpzd.top/assets/images/avatar.png",
